...
const Checkout = () => {
    ...
    // console.log(email);
    // console.log(total);
    const paymentHendler = () =>{
        axios.post("http://localhost:3001/checkout",{email,total})
        .then(res=>{console.log(`Order successful and send mail`)})
    ...
    //toastify
    const notify = () => toast.success('Your Payment Successfuly Completed!', {
